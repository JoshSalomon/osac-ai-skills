...
Measures PRD and design review skill quality via [agent-eval-harness](https://github.com/opendatahub-io/agent-eval-harness) from the `osac-ai-skills` root.
...
Prerequisites, bootstrap model, and location decision:
[`../README.md`](../README.md).

## Quick start

```bash
# From osac-ai-skills root (with consumer sibling layout as needed)
